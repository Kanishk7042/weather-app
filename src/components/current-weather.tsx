            ...
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-2">
                <p className="text-sm font-medium text-muted-foreground">
                  ...
                  <span className="ml-2">{formatTemp(feels_like)}</span> {/* Increased space here */}
                </p>
                <div className="space-y-1 text-sm font-medium text-muted-foreground">
                  <p className="flex items-center gap-2 text-blue-500">
                    <ArrowDown className="h-3 w-3" />
                    <span>Min: {formatTemp(temp_min)}</span> {/* Increased gap */}
                  </p>
                  <p className="flex items-center gap-2 text-red-500">
                    <ArrowUp className="h-3 w-3" />
                    <span>Max: {formatTemp(temp_max)}</span> {/* Increased gap */}
                  </p>
                </div>
              </div>
            </div>
